...
default_args = {
    ...
    'project_id': 'numeric-pilot-274415'
}
...
storage_to_bigquery_task = GoogleCloudStorageToBigQueryOperator(
    ...
    bucket='nathan_bucket', # 생성한 bucket 이름을 넣으세요
    source_objects=[f"data/bike_data_{execution_date}.csv"],
    source_format='CSV',
    destination_project_dataset_table=f'numeric-pilot-274415.temp.bike_{execution_date}', # 맨 앞 project_id 변경하세요
...
FROM `numeric-pilot-274415.temp.bike_{execution_date}`
